...
#define REG_VOLTAGE_SCALE 0x01

/* Flash wait period */
#define FLASH_WAIT_PERIOD 0x05
...
/* Select regulator voltage output Scale 1 mode */
#define REG_VOLTAGE_SCALE 0x03

/* Flash wait period */
#define FLASH_WAIT_PERIOD 0x04
#endif /* APM32F411xx */
...
void SystemCoreClockUpdate(void)
{
    ...
    switch (sysClock)
    {
        ...
        case 2:
            pllClock = RCM->PLL1CFG_B.PLLCLKS;
