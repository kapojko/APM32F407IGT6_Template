...
#if defined (APM32F405xx) || defined (APM32F407xx) || defined (APM32F415xx) || defined (APM32F417xx) || defined (APM32F411xx)
    /* Reset PLL2CFG register */
    RCM->PLL2CFG = 0x20003000;
#endif /* APM32F405xx || APM32F407xx || APM32F415xx || APM32F417xx || APM32F411xx */
...
{
    RCM->PLL1CFG_B.PLLCLKS = pllSelect;
...
uint32_t RCM_ReadSYSCLKFreq(void)
{
    ...
    switch (sysClock)
    {
        ...
        case RCM_SYSCLK_SEL_PLL:
            ...
            pllSource = RCM->PLL1CFG_B.PLLCLKS;
 ...
 *
 * @param     PCLK2 : Return the frequency of PCLK2
 *
 * @retval    None
 */
 ...
 *                       @arg RCM_AHB1_PERIPH_OTG_FS2     : Enable USB OTG FS2 clock (*)
 ...
 *                       @arg RCM_AHB1_PERIPH_OTG_FS2     : Disable USB OTG FS2 clock (*)
 ...
 *                       @arg RCM_AHB2_PERIPH_SMC       : Enable SMC clock (*)
 *                       @arg RCM_AHB2_PERIPH_QSPI      : Enable QSPI clock (*)
 ...
 *                       @arg RCM_AHB2_PERIPH_SMC       : Disable SMC clock (*)
 *                       @arg RCM_AHB2_PERIPH_QSPI      : Disable QSPI clock (*)
 ...
 *                       This parameter can be any combination of the following values:
 *                       @arg RCM_AHB3_PERIPH_EMMC : Enable EMMC clock
 *                       @arg RCM_AHB3_PERIPH_QSPI : Enable QSPI clock (*)
 *
 * @retval    None
 */
 ...
 *                       This parameter can be any combination of the following values:
 *                       @arg RCM_AHB3_PERIPH_EMMC : Disable EMMC clock
 *                       @arg RCM_AHB3_PERIPH_QSPI : Disable QSPI clock (*)
 *
 * @retval    None
 */
 ...
 *                        @arg RCM_APB2_PERIPH_COMP   : COMP clock (*)
 ...
 *                       @arg RCM_AHB1_PERIPH_OTG_FS2     : Enable USB OTG FS2 reset (*)
 ...
 *                       @arg RCM_AHB1_PERIPH_GPIOH       : Disable GPIOH reset
 ...
 *                       @arg RCM_AHB1_PERIPH_OTG_FS2     : Disable USB OTG FS2 reset (*)
 ...
 *                       @arg RCM_AHB2_PERIPH_SMC       : Enable SMC reset (*)
 *                       @arg RCM_AHB2_PERIPH_BN        : Enable BN reset (*)
 *                       @arg RCM_AHB2_PERIPH_QSPI      : Enable QSPI reset (*)
 ...
 *                       @arg RCM_AHB2_PERIPH_SMC       : Disable SMC reset (*)
 *                       @arg RCM_AHB2_PERIPH_BN        : Disable BN reset (*)
 *                       @arg RCM_AHB2_PERIPH_QSPI      : Disable QSPI reset (*)
 ...
 * @param    AHB3Periph : Enable the specifies clock of AHB2 peripheral
 *                       This parameter can be any combination of the following values:
 *                       @arg RCM_AHB3_PERIPH_EMMC : Enable EMMC reset
 *                       @arg RCM_AHB3_PERIPH_QSPI : Enable QSPI reset (*)
 *
 * @retval    None
 */
 ...
 * @param    AHB2Periph : Disable the specifies clock of AHB3 peripheral
 *                       This parameter can be any combination of the following values:
 *                       @arg RCM_AHB3_PERIPH_EMMC : Disable EMMC reset
 *                       @arg RCM_AHB3_PERIPH_QSPI : Disable QSPI reset (*)
 *
 * @retval    None
 */
 ...
 *                        @arg RCM_APB2_PERIPH_ADC    : All of ADC clock reset (*)
 ...
 *                       @arg RCM_AHB1_PERIPH_SRAM2       : Enable SRAM2 clock (*)
 *                       @arg RCM_AHB1_PERIPH_SRAM3       : Enable SRAM3 clock (*)
 *                       @arg RCM_AHB1_PERIPH_BKPSRAM     : Enable BKPSRAM clock (*)
 *                       @arg RCM_AHB1_PERIPH_DMA1        : Enable DMA1 clock
 *                       @arg RCM_AHB1_PERIPH_DMA2        : Enable DMA2 clock
 *                       @arg RCM_AHB1_PERIPH_ETH_MAC     : Enable Ethernet MAC clock (*)
 *                       @arg RCM_AHB1_PERIPH_ETH_MAC_Tx  : Enable Ethernet Transmission clock (*)
 ...
 *                       @arg RCM_AHB1_PERIPH_SRAM2       : Disable SRAM2 clock (*)
 *                       @arg RCM_AHB1_PERIPH_SRAM3       : Disable SRAM3 clock (*)
 *                       @arg RCM_AHB1_PERIPH_BKPSRAM     : Disable BKPSRAM clock (*)
 *                       @arg RCM_AHB1_PERIPH_DMA1        : Disable DMA1 clock
 *                       @arg RCM_AHB1_PERIPH_DMA2        : Disable DMA2 clock
 *                       @arg RCM_AHB1_PERIPH_ETH_MAC     : Disable Ethernet MAC clock (*)
 *                       @arg RCM_AHB1_PERIPH_ETH_MAC_Tx  : Disable Ethernet Transmission clock (*)
