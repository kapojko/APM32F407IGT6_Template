...
/*!
 * @brief     Reset the DMC registers to their default reset values.
 *
 * @param     None
 *
 * @retval    None
...
void DMC_Reset(void)
{
    RCM_EnableAHB3PeriphReset(RCM_AHB3_PERIPH_EMMC);
    RCM_DisableAHB3PeriphReset(RCM_AHB3_PERIPH_EMMC);
}
