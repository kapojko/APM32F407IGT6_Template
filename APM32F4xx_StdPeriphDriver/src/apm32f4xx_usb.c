 ...
 *                    This value can be one of the following values:
 *                    @arg USB_OTG_MODE_DEVICE : Force device mode.
 *                    @arg USB_OTG_MODE_HOST   : Force host mode.
 *
 * @retval      None
 */
 ...
 *              @arg CHANNEL_INT_TSFCMPAN
 *              @arg CHANNEL_INT_AHBERR
 *              @arg CHANNEL_INT_RXSTALL
 *              @arg CHANNEL_INT_RXNAK
 *              @arg CHANNEL_INT_RXTXACK
 *              @arg CHANNEL_INT_RXNYET
 *              @arg CHANNEL_INT_TERR
 *              @arg CHANNEL_INT_BABBLE
 *              @arg CHANNEL_INT_FOVR
 *              @arg CHANNEL_INT_DTOG
 *              @arg CHANNEL_INT_ALL
 *
