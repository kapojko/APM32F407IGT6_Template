...
typedef enum
{
    SMC_WAIT_SIGNAL_DISABLE,   /*!< Disable wait signal */
    SMC_WAIT_SIGNAL_ENABLE     /*!< Enable wait signal */
} SMC_WAIT_SIGNAL_T;
...
typedef struct
{
    ...
    uint8_t           addressHoldTime;      /*!< Set address-hold setup time */
...
typedef struct
{
    ...
    SMC_WAIT_SIGNAL_T          waitSignal;             /*!< Set wait signal */
