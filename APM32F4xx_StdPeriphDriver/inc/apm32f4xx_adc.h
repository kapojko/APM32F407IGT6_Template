...
#define ADC_COMMON_REGISTER(__INSTANCE__)                ADC
#elif defined(APM32F411xx)
#define ADC_COMMON_REGISTER(__INSTANCE__)                ((__INSTANCE__) == ADC1 ? ADC1_COMMON : ADC2_COMMON)
#else
#define ADC_COMMON_REGISTER(__INSTANCE__)                ADC
#endif /* APM32F405xx || APM32F407xx || APM32F415xx || APM32F417xx || APM32F425xx || APM32F427xx */

/**
  * @brief ADC Common instance
  */
#if defined(APM32F405xx) || defined(APM32F407xx) || defined(APM32F415xx) || defined(APM32F417xx) || defined(APM32F425xx) || defined(APM32F427xx)
#define ADC_COMMON_INSTANCE                             ADC
#else
...
typedef enum
{
    ADC_OVERSAMPLING_RATIO_2   = 0x00, /*!< Oversampling ratio 2 */
    ADC_OVERSAMPLING_RATIO_4   = 0x01, /*!< Oversampling ratio 4 */
    ADC_OVERSAMPLING_RATIO_8   = 0x02, /*!< Oversampling ratio 8 */
    ADC_OVERSAMPLING_RATIO_16  = 0x03, /*!< Oversampling ratio 16 */
    ADC_OVERSAMPLING_RATIO_32  = 0x04, /*!< Oversampling ratio 32 */
    ADC_OVERSAMPLING_RATIO_64  = 0x05, /*!< Oversampling ratio 64 */
    ADC_OVERSAMPLING_RATIO_128 = 0x06, /*!< Oversampling ratio 128 */
    ADC_OVERSAMPLING_RATIO_256 = 0x07  /*!< Oversampling ratio 256 */
} ADC_OVERSAMPLING_RATIO_T;
...
typedef enum
{
    ADC_OVERSAMPLING_SHIFT_0    = 0x00, /*!< No oversampling shift */
    ADC_OVERSAMPLING_SHIFT_1    = 0x01, /*!< Oversampling shift 1 */
    ADC_OVERSAMPLING_SHIFT_2    = 0x02, /*!< Oversampling shift 2 */
    ADC_OVERSAMPLING_SHIFT_3    = 0x03, /*!< Oversampling shift 3 */
    ADC_OVERSAMPLING_SHIFT_4    = 0x04, /*!< Oversampling shift 4 */
    ADC_OVERSAMPLING_SHIFT_5    = 0x05, /*!< Oversampling shift 5 */
    ADC_OVERSAMPLING_SHIFT_6    = 0x06, /*!< Oversampling shift 6 */
    ADC_OVERSAMPLING_SHIFT_7    = 0x07, /*!< Oversampling shift 7 */
    ADC_OVERSAMPLING_SHIFT_8    = 0x08  /*!< Oversampling shift 8 */
} ADC_OVERSAMPLING_SHIFT_T;

/**
 * @brief ADC oversampling trigger
 */
typedef enum
{
    ADC_OVERSAMPLING_TRIGGER_ALL  = 0x00, /*!< After one trigger, execute all the oversampling channel conversions */
    ADC_OVERSAMPLING_TRIGGER_EACH = 0x01  /*!< Need trigger for each oversampling channel conversion */
} ADC_OVERSAMPLING_TRIGGER_T;
...
typedef enum
{
    ADC_INT_FLAG_EOC    = 0x0502,   /*!< End of conversion interrupt flag */
    ADC_INT_FLAG_AWD    = 0x0601,   /*!< Analog watchdog interrupt flag */
