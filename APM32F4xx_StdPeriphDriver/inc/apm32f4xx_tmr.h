...
typedef enum
{
    ...
    TMR_DMA_SOURCE_CC1       = 0x0200,  /*!< TMR Capture Compare 1 DMA souces */
    TMR_DMA_SOURCE_CC2       = 0x0400,  /*!< TMR Capture Compare 2 DMA souces */
    TMR_DMA_SOURCE_CC3       = 0x0800,  /*!< TMR Capture Compare 3 DMA souces */
    TMR_DMA_SOURCE_CC4       = 0x1000,  /*!< TMR Capture Compare 4 DMA souces */
...
typedef enum
{
    ...
    TMR2_OTG_FS2USB_SOF = 0x0C00,   /*!< TMR2 ITR1 input is connected to OTG FS2 SOF */
...
void TMR_ConfigCounter(TMR_T* tmr, uint32_t counter);
void TMR_ConfigAutoreload(TMR_T* tmr, uint32_t autoReload);
uint32_t TMR_ReadCounter(TMR_T* tmr);
