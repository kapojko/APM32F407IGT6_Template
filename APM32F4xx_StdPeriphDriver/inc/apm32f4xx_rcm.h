...
typedef enum
{
    RCM_MCO2_SEL_SYSCLK = 0,    /*!< SYS clock selected as MCO2 source */
#if defined (APM32F405xx) || defined (APM32F407xx) || defined (APM32F415xx) || defined (APM32F417xx) || defined (APM32F411xx)
    RCM_MCO2_SEL_PLL2CLK = 1,   /*!< PLL2 clock selected as MCO2 source */
#endif /* APM32F405xx || APM32F407xx || APM32F415xx || APM32F417xx || APM32F411xx */
    RCM_MCO2_SEL_HSECLK = 2,    /*!< HSE clock selected as MCO2 source */
    RCM_MCO2_SEL_PLLCLK = 3     /*!< PLL clock selected as MCO2 source */
} RCM_MCO2_SEL_T;
...
#if defined (APM32F407xx) || defined (APM32F417xx) || defined (APM32F425xx) || defined (APM32F427xx)
...
#endif /* APM32F407xx || APM32F417xx || APM32F425xx || APM32F427xx */

#if defined (APM32F425xx) || defined (APM32F427xx)
    RCM_AHB1_PERIPH_OTG_FS2      = BIT29,   /*!< Select OTG FS2 clock */
#endif /* APM32F425xx || APM32F427xx */
#if defined (APM32F405xx) || defined (APM32F407xx) || defined (APM32F415xx) || defined (APM32F417xx)
...
typedef enum
{
    ...
    RCM_AHB2_PERIPH_SMC    = BIT1,  /*!< Select SMC clock */
#endif /* APM32F411xx */
#if defined(APM32F405xx) || defined(APM32F407xx) || defined(APM32F415xx) || defined(APM32F417xx)
...
#endif /* APM32F411xx */
#if defined(APM32F405xx) || defined(APM32F407xx) || defined(APM32F415xx) || defined(APM32F417xx) || defined(APM32F411xx) || defined(APM32F425xx) || defined(APM32F427xx)
#if defined(APM32F405xx) || defined(APM32F407xx) || defined(APM32F415xx) || defined(APM32F417xx)
...
#if defined (APM32F411xx)
    RCM_APB2_PERIPH_COMP   = BIT14,     /*!< Select COMP clock shared with SYSCFG */
#endif /* APM32F411xx */
...
#if defined (APM32F405xx) || defined (APM32F407xx) || defined (APM32F411xx) || \
    defined (APM32F415xx) || defined (APM32F417xx)
void RCM_ConfigI2SCLK(RCM_I2S_CLK_T i2sClkSource);
#endif /* APM32F405xx || APM32F407xx || APM32F411xx || APM32F415xx || APM32F417xx */
