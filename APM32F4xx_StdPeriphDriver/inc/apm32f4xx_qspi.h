...
#ifndef __APM32F4XX_QSPI_H
#define __APM32F4XX_QSPI_H
...
/**
 * @brief QSPI DMA enable
 */
typedef enum
{
    QSPI_DMA_RX    = (uint8_t)0x01,    /*!< QSPI DMA transmit request */
    QSPI_DMA_TX    = (uint8_t)0x02,    /*!< QSPI DMA receive request */
    QSPI_DMA_TX_RX = (uint8_t)0x03     /*!< QSPI DMA transmit/receive request */
} QSPI_DMA_T;
...
/**
 * @brief   QSPI External Memory Access format
 */
typedef enum
{
    QSPI_MEM_ACCESS_BIG_ENDIAN,
    QSPI_MEM_ACCESS_LITTLE_ENDIAN
} QSPI_MEM_ACCESS_FORMAT_T;

/**
 * @brief   QSPI XIP frame format
 */
typedef enum
{
    QSPI_XIP_FRAME_DUAL = 0x01,
    QSPI_XIP_FRAME_QUAD = 0x02,
} QSPI_XIP_FRF_T;

/**
 * @brief   QSPI XIP instruction and address transmission mode
 */
typedef enum
{
    QSPI_XIP_INST_ADDR_TYPE_STANDARD,
    QSPI_XIP_INST_TYPE_STANDARD,
    QSPI_XIP_INST_ADDR_TYPE_FRF
} QSPI_XIP_INST_ADDR_TYPE_T;

/**
 * @brief   QSPI XIP address length
 */
typedef enum
{
    QSPI_XIP_ADDR_LEN_0,
    QSPI_XIP_ADDR_LEN_4BIT,
    QSPI_XIP_ADDR_LEN_8BIT,
    QSPI_XIP_ADDR_LEN_12BIT,
    QSPI_XIP_ADDR_LEN_16BIT,
    QSPI_XIP_ADDR_LEN_20BIT,
    QSPI_XIP_ADDR_LEN_24BIT,
    QSPI_XIP_ADDR_LEN_28BIT,
    QSPI_XIP_ADDR_LEN_32BIT,
    QSPI_XIP_ADDR_LEN_36BIT,
    QSPI_XIP_ADDR_LEN_40BIT,
    QSPI_XIP_ADDR_LEN_44BIT,
    QSPI_XIP_ADDR_LEN_48BIT,
    QSPI_XIP_ADDR_LEN_52BIT,
    QSPI_XIP_ADDR_LEN_56BIT,
    QSPI_XIP_ADDR_LEN_60BIT
} QSPI_XIP_ADDR_LEN_T;

/**
 * @brief   QSPI XIP Instruction length
 */
typedef enum
{
    QSPI_XIP_INST_LEN_0,
    QSPI_XIP_INST_LEN_4BIT,
    QSPI_XIP_INST_LEN_8BIT,
    QSPI_XIP_INST_LEN_16BIT
} QSPI_XIP_INST_LEN_T;
